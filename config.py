...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7901376745:AAHDUIt6vSnME1X_RhyRrAYAzWF0em8miKs")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "28372387")

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "11edc85521fb2d8f75e751bb284507e1")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "5921378472"))
...
DB_NAME = os.environ.get("DB_NAME", "stinersaverestrictcontentbot")
